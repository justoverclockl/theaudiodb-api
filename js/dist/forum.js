...
flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.initializers.add('justoverclock/theaudiodb-api', function () {
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_forum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'oncreate', function () {
    ...
    var languageCode = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('justoverclock-theaudiodb-api.langCode') || 'EN';
    ...
    if (isLoggedIn) {
      var ArtistApi = fetch('https://theaudiodb.com/api/v1/json/1/search.php?s=' + artistTitle).then(handleErrors).then(function (response) {
        ...
        return console.log('This Game title does not exist ;) =>', artistTitle);
      });
    }
  });
  Object(flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__["extend"])(flarum_forum_components_DiscussionHero__WEBPACK_IMPORTED_MODULE_2___default.a.prototype, 'items', function (items) {
    var languageCode = flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.forum.attribute('justoverclock-theaudiodb-api.langCode') || 'EN';
    var arrayElem = 'strBiography' + languageCode;
    console.log(this.audiodb); // non mostriamo l'html se non c'è nulla da mostrare
    ...
    if (this.audiodb === undefined) {
      ...
      items.add('artistDetailMusic', m("div", {
        ...
        "class": "artistDesc",
        id: "descArtist"
      }, this.audiodb.artists[0][arrayElem].substring(0, 400) + '...'), m("div", {
        "class": "itemdescrip"
      }, m("div", {
        "class": "genreArtist",
        id: "genreArtist"
      }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('justoverclock-theaudiodb-api.forum.genres'), ": ", this.audiodb.artists[0].strGenre), m("div", {
        "class": "yearBorn",
        id: "yearBorn"
      }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('justoverclock-theaudiodb-api.forum.intFormedYear'), ": ", this.audiodb.artists[0].intFormedYear), m("div", {
        "class": "strcountry",
        id: "strcountry"
      }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default.a.translator.trans('justoverclock-theaudiodb-api.forum.countryart'), ": ", this.audiodb.artists[0].strCountry)))), m("div", {
        id: "sidebarImgArtist"
      }, m("img", {
        className: "imgArtist",
        id: "imgArtists",
        src: this.audiodb.artists[0].strArtistThumb
      }))));
    }
  });
});
